                        ...
                        {['Emperor', 'Spacing Guild', 'Bene Gesserit', 'Fremen'].map(faction => {
                            ...
                            return (
                                <div key={faction} style={{
                                    ...
                                    <img
                                        src={`/assets/${encodeURIComponent(faction)}.png`}
                                        alt={faction}
                                        style={{
                                            width: '32px',
                                            height: '32px',
                        ...
                        {[
                            ...
                            return (
                                <div key={upgrade.id} style={{
                                    ...
                                    <img
                                        src={`/assets/${encodeURIComponent(upgrade.id)}.png`}
                                        alt={upgrade.id}
                                        style={{
                                            width: '32px',
                                            height: '32px',
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{
                                                ...
                                                {act.imageAsset && (
                                                    <img
                                                        src={`/assets/${encodeURIComponent(act.imageAsset)}${act.imageAsset.includes('.') ? '' : '.png'}`}
                                                        alt={act.imageAsset}
                                                        style={{
                                                            width: '70px',
                                                            height: '70px',
